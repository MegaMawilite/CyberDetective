...
test.scrape(query="Votre recherche", language="fr", results_count=500, filepath="results.csv", since="2022-06-01")
...
class Scraper:
	...
	def scrape(self, filepath=None, query=None, results_count=0, language="en", since="2020-01-01"):
        ...
        (Louis)
        - since : la date à partir de laquelle il faut rechercher (YYYY-MM-DD)
        """

		tweets_max_time = int(time.time()) - 604800

		search = query + " lang:" + language + " since:" + since
